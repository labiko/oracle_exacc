...
-- # ------- | ---------- | --------- | ------ | -------------------------
-- # 1.8     | 20/02/2026 | DTC670    | JOB    | OPTIMISATION SQL_ID 4v9ag77cam8uu
-- #                                           | Curseur Curseur_Attendus_DC_Max optimise avec CTE :
-- #                                           |   - CTE dc_max_calc : calcul DC_MAX une seule fois
-- #                                           |   - CTE compte_hierarchie : factorisation hierarchie comptes
-- #                                           |   - UNION ALL au lieu de UNION (statuts exclusifs)
-- #                                           |   - Hints LEADING + USE_HASH + MATERIALIZE
-- #                                           | GAIN ATTENDU : 80-90% reduction temps execution
-- ***********************************************************************
...
/* *************************************************************** */
-- ============================================================
-- [OPTIMISE 20/02/2026] DTC670 - SQL_ID 4v9ag77cam8uu
-- VERSION CTE : dc_max_calc + compte_hierarchie
-- GAIN ATTENDU : 80-90% reduction temps execution
-- ============================================================
...
UNION ALL  -- [OPTIMISE] UNION ALL car OUTSTANDING et RECONCILED sont mutuellement exclusifs
