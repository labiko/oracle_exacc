-- ============================================================================
-- VÉRIFICATION CUMUL - Compte 394 (Transaction 22.36 EUR)
-- ============================================================================
...
PROMPT ============================================================================
PROMPT PARAMÉTRAGE CUMUL - Compte 394 (BNPP05492-EUR) - Transaction 22.36 EUR
PROMPT ============================================================================

PROMPT
PROMPT 1. Informations du compte 394
PROMPT
...
PROMPT ============================================================================
PROMPT 2. RÈGLES DE CUMUL pour le compte 394
PROMPT ============================================================================
...
PROMPT   → La transaction 22.36 EUR (mode VO) serait dans un CUMUL QUOTIDIEN
PROMPT

PROMPT ============================================================================
PROMPT 3. NOMBRE TOTAL de règles de cumul pour le compte 394
PROMPT ============================================================================
...
PROMPT ============================================================================
PROMPT 4. VÉRIFICATION SPÉCIFIQUE - Règle ALL+VO (qui impacte 22.36 EUR)
PROMPT ============================================================================
...
SELECT
    ...
    CASE
        WHEN COUNT(*) > 0 THEN '[KO] Transaction 22.36 sera CUMULEE (mode VO)'
        ELSE '[OK] Transaction 22.36 sera exportee EN DETAIL'
    END AS IMPACT_SUR_22_36
FROM TA_RN_GESTION_ACCURATE GA
    JOIN TA_RN_CUMUL_MR CMR ON CMR.ID_COMPTE_BANCAIRE_SYSTEME = GA.ID_COMPTE_BANCAIRE_SYSTEME
    JOIN TA_RN_PRODUIT P ON P.ID_PRODUIT = CMR.ID_PRODUIT
    JOIN TA_RN_MODE_REGLEMENT MR ON MR.ID_MODE_REGLEMENT = CMR.ID_MODE_REGLEMENT
...
PROMPT ============================================================================
PROMPT FIN VÉRIFICATION - Compte 394
PROMPT ============================================================================
