...
# powershell.exe -File "C:\Users\diall\Documents\IonicProjects\Claude\RECHERCHER\DIVERS\POWER-SHELL\PAIN-Auto-Processor.ps1"
#
# METHODE 2 - Depuis PowerShell uniquement (avec l'operateur & ou .) :
# & "C:\Users\diall\Documents\IonicProjects\Claude\RECHERCHER\DIVERS\POWER-SHELL\PAIN-Auto-Processor.ps1"
#
# METHODE 3 - Clic droit dans l'Explorateur Windows :
# Clic droit sur le fichier -> "Executer avec PowerShell"
#
# NOTE : .\script.ps1 ouvre Notepad par defaut (association Windows)
