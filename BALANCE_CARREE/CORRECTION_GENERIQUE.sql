...
PROMPT DIFF devrait etre 0
PROMPT
PROMPT Pour ROLLBACK :
PROMPT UPDATE BANKREC.BRD_EU_JC_SUMMARY SET BAL_ST = BAL_ST + <ANCIEN_DIFF>, DIFF = <ANCIEN_DIFF> WHERE ACCT_ID = &V_ACCT_ID AND PERIOD_JC = &V_PERIOD_JC;
PROMPT
